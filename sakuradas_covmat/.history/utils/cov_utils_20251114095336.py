...
def network_covmat():
    ...
    os.makedirs('covmat_data/sakura2022', exist_ok=True)
    np.savez_compressed('covmat_data/sakura2022/covmat_'+fiber+'_'+hdf5_starttime_jst.strftime("%Y%m%d-%H%M%S")+"_"+str(Nseconds).zfill(4)+".npz",
                        datetime_num=x,
                        frequencies=y,
...
if __name__ == "__main__":
    ...
    hdf5_endttime_jst = datetime.datetime(2022, 12, 8, 6, 0, 0) 
    network_covmat()
